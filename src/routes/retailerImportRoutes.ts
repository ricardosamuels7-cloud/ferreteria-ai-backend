...
export const retailerImportRoutes = Router();

retailerImportRoutes.post("/import", async (req, res) => {
  ...
  try {
    ...
    for (const p of products) {
      await client.query(
        `INSERT INTO products (retailer_id, store_id, sku, name, category, price, stock, currency, image_url)
